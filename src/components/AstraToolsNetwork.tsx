      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 md:mb-24">
          ...
          <motion.h2 
            ...
            className="font-heading font-normal uppercase leading-[1.1] tracking-[0.1em] text-3xl sm:text-4xl md:text-[3.5rem] lg:text-[4rem] mb-6"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 auto-rows-[280px]">
          ...
          <motion.div 
            ...
            className="md:col-span-2 lg:col-span-2 row-span-2 group relative p-8 rounded-3xl bg-white border border-black/[0.06] hover:border-primary/30 hover:shadow-xl transition-all duration-500 overflow-hidden cursor-pointer"
          >
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="w-12 h-12 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center mb-auto">
              ...
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[60%] h-full opacity-10 group-hover:opacity-30 transition-opacity duration-700 pointer-events-none">
                <div className="absolute top-1/4 right-10 w-24 h-[1px] bg-primary" />
                <div className="absolute top-1/2 right-10 w-48 h-[1px] bg-primary" />
                <div className="absolute top-3/4 right-10 w-32 h-[1px] bg-primary" />
                <div className="absolute top-1/4 right-32 w-2 h-2 rounded-full bg-primary" />
                <div className="absolute top-1/2 right-56 w-2 h-2 rounded-full bg-primary" />
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ delay: 0.2 }}
            onClick={() => navigate('/products/astra-tools')}
            className="md:col-span-1 lg:col-span-2 group relative p-8 rounded-3xl bg-white border border-black/[0.06] hover:border-black/20 hover:shadow-lg transition-all duration-500 cursor-pointer overflow-hidden flex flex-col justify-between"
          >
            <div className="relative z-10 flex justify-between items-start">
              <Terminal className="w-8 h-8 text-black/40 group-hover:text-black transition-colors" />
              <ArrowRight className="w-5 h-5 text-black/20 group-hover:text-black transition-colors transform group-hover:-rotate-45" />
            </div>
          ...
          <motion.div 
            ...
            onClick={() => navigate('/products/astra-tools')}
            className="group relative p-8 rounded-3xl bg-white border border-black/[0.06] hover:border-blue-500/30 hover:shadow-lg transition-all duration-500 cursor-pointer overflow-hidden flex flex-col justify-between"
          >
          ...
          <motion.div 
            ...
            onClick={() => navigate('/products/astra-tools')}
            className="group relative p-8 rounded-3xl bg-white border border-black/[0.06] hover:border-red-500/30 hover:shadow-lg transition-all duration-500 cursor-pointer overflow-hidden flex flex-col justify-between"
          >
