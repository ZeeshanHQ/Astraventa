...
const ServiceDetail = () => {
 ...
 >
 <div className={`w-20 h-20 rounded-[2.5rem] ${service.bg} flex items-center justify-center mb-10`}>
 <service.icon className={`w-10 h-10 ${service.color}`} />
 </div>
 <h1 className="text-5xl md:text-8xl font-bold text-slate-900 mb-8 font-heading tracking-tighter leading-[0.9] uppercase">
 {service.title}
 </h1>
 <p className="text-2xl font-bold text-primary mb-10 tracking-tighter font-heading uppercase">
 {service.subtitle}
 </p>
 <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-3xl mb-12">
 {service.description}
 </p>
 <Button size="lg" className="rounded-full h-16 px-12 font-bold font-heading tracking-tighter uppercase text-sm">Start a Project</Button>
 </motion.div>
 </div>
 </section>
 ...
 <div key={i} className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
 <div className="text-4xl font-black text-primary/40 mb-6 font-heading">{p.step}</div>
 ...
 <div className="p-16 rounded-[4rem] bg-blue-50 border border-blue-100 relative overflow-hidden">
 <div className="absolute top-[-10%] right-[-10%] opacity-10">
 <service.icon size={300} />
 </div>
 <h2 className="text-4xl md:text-7xl font-bold text-slate-900 mb-8 font-heading tracking-tighter uppercase">Ready to build?</h2>
 <p className="text-xl text-slate-500 font-medium mb-12 max-w-2xl mx-auto font-sans leading-relaxed text-sm">
 Our experts are ready to take your business to the next level with our {service.title.toLowerCase()} expertise.
 </p>
 <Button size="lg" className="rounded-full h-16 px-12 font-bold font-heading tracking-tighter uppercase text-sm">Book a Free Call</Button>
 </div>
 </section>
 </main>
