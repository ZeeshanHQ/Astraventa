...
const Careers = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-[#0066FF]/10 selection:text-[#0066FF]">
      <Header />
      ...
      <main className="pt-32 pb-24 px-6 overflow-hidden">
        ...
        <section className="relative max-w-[1400px] mx-auto mb-32">
          ...
          <div className="max-w-4xl pt-20">
            <motion.div {...fadeUp} className="mb-8">
              ...
              <h1 className="text-6xl md:text-8xl font-black text-slate-950 tracking-tight leading-[0.9] mb-8 uppercase italic">
                Join the <br />
        ...
        <section className="max-w-[1400px] mx-auto py-24 border-t border-slate-100 relative">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 relative z-10">
            <div>
              <div className="text-[10px] font-black text-[#0066FF] uppercase tracking-[0.3em] mb-4 leading-none">Current Opportunities</div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-950 tracking-tight leading-none uppercase italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
            {roles.map((role, i) => (
              <motion.div
                ...
                className="group p-8 bg-white border border-slate-100 rounded-[2.5rem] hover:border-[#0066FF]/30 hover:shadow-2xl hover:shadow-[#0066FF]/5 transition-all duration-500 flex flex-col items-start"
              >
                <div className="w-14 h-14 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-6 group-hover:bg-[#0066FF]/5 group-hover:border-[#0066FF]/20 transition-all duration-500">
                  <role.icon className="w-6 h-6 text-slate-400 group-hover:text-[#0066FF] transition-colors" />
                </div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[10px] font-black text-[#0066FF] uppercase tracking-widest">{role.team}</span>
                  <span className="w-1 h-1 rounded-full bg-slate-200" />
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{role.type}</span>
                </div>
                <h3 className="text-2xl font-black text-slate-900 mb-4 tracking-tight group-hover:text-[#0066FF] transition-colors uppercase italic leading-none">{role.title}</h3>
        ...
        <section className="max-w-[1400px] mx-auto py-32 bg-slate-950 rounded-[4rem] px-12 relative overflow-hidden group">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            <motion.div {...fadeUp}>
              <div className="text-[10px] font-black text-[#0066FF] uppercase tracking-[0.3em] mb-6">Operating Principles</div>
              <h2 className="text-5xl md:text-7xl font-black text-white tracking-tight leading-[0.95] mb-8 uppercase italic">
                Engineering <br />
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-6xl font-black text-white mb-2 tracking-tighter italic">99.9%</div>
        ...
        <section className="max-w-[800px] mx-auto py-32 text-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-5xl font-black text-slate-900 mb-8 tracking-tight uppercase italic leading-none">
