                        ...
                        >
                            ...
                            <div>
                              <div className="flex items-center gap-3 mb-2">
                                <div className="font-black text-slate-900 tracking-tight">Haider Shabbir & Zeeshan Jay</div>
                                <div className="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest bg-emerald-100 text-emerald-700">Co-Founders</div>
                              </div>
                            </div>
                        </motion.div>
                    </div>
