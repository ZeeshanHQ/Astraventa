...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="text-align: center; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 2px solid #3b82f6;">
    <h1 style="color: #1e293b; margin: 0; font-size: 24px;">Astraventa Monthly Report</h1>
  ...
  <p style="color: #64748b; font-size: 12px; text-align: center; margin-top: 30px;">
    Detailed PDF report attached.<br>
  ...
  <div class="footer">
    ...
    const emailResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        attachments: [
          {
            filename: `astraventa-report-${monthName}-${targetYear}.html`,
            content: detailedHtmlReport,
            type: 'text/html'
          }
        ]
      })
