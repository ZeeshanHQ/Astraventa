...
import { ArrowLeft, Activity, Newspaper, Target, Sparkles, Building2, Users, FlaskConical, LifeBuoy, ShieldCheck, Image as ImageIcon } from "lucide-react";
...
const pageData: any = {
  ...
  "changelog": {
    ...
    color: "text-rose-600",
    bg: "bg-rose-50",
    content: "v1.0.0 Released: Initial Ecosystem Launch. Deployed global navigation infrastructure."
  },
  "about": {
    ...
    bg: "bg-indigo-50",
    content: "Founded by Haider Shabbir & Zeeshan Jay, we are on a mission to democratize enterprise-grade AI infrastructure for global businesses."
  },
  "careers": {
  ...
  "lab": {
    ...
    color: "text-primary",
    bg: "bg-primary/10",
    content: "Currently testing: Project Neural-Link UI, Autonomous Code Repair Agent v1.0."
  },
  "support": {
    title: "Help Center",
