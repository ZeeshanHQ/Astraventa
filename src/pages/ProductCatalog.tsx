...
const products: Product[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1557200134-90327ee9fafa?q=80&w=1200",
    engineSpecs: [
    ...
    >
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="flex flex-wrap gap-4 pt-6 border-t border-slate-50">
          <Button
            className="h-10 px-8 bg-black text-white hover:bg-slate-900 rounded-xl font-heading font-normal text-[11px] uppercase tracking-widest flex items-center gap-2 shadow-custom transition-all"
            asChild
          >
          ...
          <Button
            variant="outline"
            className="h-10 px-8 border-slate-200 text-slate-600 hover:bg-slate-50 rounded-xl font-heading font-normal text-[11px] uppercase tracking-widest flex items-center gap-2 transition-all"
            asChild
          >
            ...
            <div className="mt-16">
              <div className="md:flex md:justify-end items-center gap-6">
                ...
                <div className="flex w-full items-end gap-4 mt-4 md:mt-0">
                  ...
                  <span className="text-3xl md:text-5xl font-bold text-[hsl(var(--primary))]">products</span>
                </div>
              </div>
            </div>
          </div>
