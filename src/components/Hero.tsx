            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl">
                {[
                  ...
                  <motion.div 
                    key={index} 
                    className="glass-card p-6 rounded-2xl hover:shadow-glow-lg transition-all duration-300 group cursor-pointer"
                  ...
                  >
                    ...
                    {/* Hover Effect */}
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                      initial={{ opacity: 0 }}
