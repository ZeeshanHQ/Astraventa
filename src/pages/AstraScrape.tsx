...
{`{
 ...
 >
 <div className={`w-12 h-12 shrink-0 rounded-2xl flex items-center justify-center shadow-2xl transition-all hover:rotate-12 ${
 msg.role === 'user' ? 'bg-emerald-600 text-white' : 'bg-slate-800 border border-white/10 text-emerald-400'
 }`}>
 ...
 <div className={`px-8 py-6 rounded-[2rem] text-[16px] leading-[1.7] shadow-3xl ${
 msg.role === 'user' 
 ...
 AstraScrape <span className="text-emerald-900">v7.0.2-BETA</span>
 </p>
