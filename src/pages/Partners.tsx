      ...
      <main className="pt-32 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-4xl pt-20">
            <motion.div {...fadeUp} className="mb-12">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 mb-8">
                ...
                <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] leading-none">Global Partner Network // v2.0</span>
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tiers.map((tier, i) => (
              <motion.div
                ...
                className="group p-10 bg-slate-50 border border-slate-100 rounded-[3rem] hover:bg-white hover:border-[#0066FF]/30 hover:shadow-2xl hover:shadow-[#0066FF]/10 transition-all duration-700 relative overflow-hidden"
              >
                ...
                <div className="w-16 h-16 rounded-[1.5rem] bg-white border border-slate-200 flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500">
                  <tier.icon className="w-7 h-7 text-[#0066FF]" />
                </div>
                
                <div className="text-[10px] font-black text-[#0066FF] uppercase tracking-widest mb-2">{tier.focus}</div>
                <h3 className="text-3xl font-black text-slate-900 mb-6 tracking-tight uppercase italic leading-none group-hover:text-[#0066FF] transition-colors">{tier.title}</h3>
        ...
        <section className="max-w-[1400px] mx-auto py-32 border-y border-slate-100 mb-32 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            <motion.div {...fadeUp}>
              <div className="text-[10px] font-black text-[#0066FF] uppercase tracking-[0.3em] mb-6">Network Impact</div>
              <h2 className="text-5xl md:text-7xl font-black text-slate-950 tracking-tight leading-[0.95] mb-10 uppercase italic">
                Engineering <br />
            ...
            >
              <div className="absolute top-0 right-0 w-96 h-96 bg-[#0066FF]/20 blur-[100px] rounded-full" />
              <div className="relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-8">
                  <Handshake className="w-8 h-8 text-[#0066FF]" />
                </div>
                <h4 className="text-3xl font-black text-white mb-6 tracking-tight uppercase italic underline decoration-[#0066FF] decoration-4 underline-offset-8">The Alliance Portal</h4>
        ...
        <section className="max-w-[1000px] mx-auto py-24 text-center">
          <motion.div {...fadeUp}>
            <h2 className="text-5xl md:text-6xl font-black text-slate-950 mb-12 tracking-tight leading-none uppercase italic">
              Scale your firm <br />
              <span className="text-slate-300">with Astraventa.</span>
            </h2>
            <Button size="lg" className="h-16 px-12 bg-slate-900 hover:bg-[#0066FF] text-white rounded-2xl font-black tracking-widest text-[11px] uppercase transition-all shadow-xl shadow-slate-900/20">
