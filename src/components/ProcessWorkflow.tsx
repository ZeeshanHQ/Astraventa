...
export const ProcessWorkflow = () => {
 ...
 <div className={`w-20 h-20 rounded-3xl bg-gradient-to-br ${step.color} shadow-lg shadow-black/20 flex items-center justify-center relative overflow-hidden group- transition-transform duration-500`}>
 ...
 <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-secondary/30 rounded-[3.5rem] blur-3xl group- transition-transform duration-700 opacity-40" />
 <div className="aspect-[16/10] bg-card rounded-[3.5rem] border border-white/10 overflow-hidden relative z-10 shadow-2xl transition-transform duration-700 group-">
 <img
 src={step.image}
 alt={step.title}
 className="w-full h-full object-cover grayscale-[30%] group-hover:grayscale-0 transition-all duration-700 group-"
 />
