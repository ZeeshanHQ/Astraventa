            ...
            <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="relative w-full h-[700px] flex items-center justify-center -mt-20">
                    ...
                    >
                        ...
                        >
                            <div className="w-20 h-20 rounded-2xl bg-white border border-[#7E96F6] shadow-[0_0_30px_rgba(126, 150, 246,0.3)] flex items-center justify-center relative overflow-hidden group">
                                <div className="absolute inset-0 bg-[#7E96F6]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                                <BrainCircuit className="w-10 h-10 text-[#7E96F6]" />

                                {/* Intense Inner Glow */}
                                <div className="absolute inset-0 shadow-[inset_0_0_20px_rgba(126, 150, 246,0.2)]" />
                            </div>

                            {/* Connecting Light Beam downwards */}
                            <div className="w-0.5 h-12 bg-gradient-to-b from-[#7E96F6] to-transparent relative overflow-hidden mt-2">
                                <motion.div
                        ...
                        {layers.map((layer, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        {/* Glass Slab Body */}
                                        <div className={`absolute inset-0 rounded-2xl border transition-all duration-300 ${isHovered ? 'bg-[#7E96F6]/10 border-[#7E96F6] shadow-[0_0_40px_rgba(126, 150, 246,0.25)]' : 'bg-white/90 border-slate-200 shadow-xl shadow-slate-200/50 backdrop-blur-md'}`}>
                                            ...
                                            >
                                                <h4 className={`font-black tracking-widest text-sm transition-colors duration-300 ${isHovered ? 'text-[#7E96F6]' : 'text-slate-900'}`}>{layer.title}</h4>
                                        ...
                                        <div className={`absolute -bottom-4 left-4 w-full h-4 rounded-b-2xl transition-colors duration-300 ${isHovered ? 'bg-[#7E96F6]/20' : 'bg-slate-100'}`} style={{ transform: 'skewX(45deg) translateZ(-1px)' }} />
                                        <div className={`absolute top-4 -right-4 w-4 h-[calc(100%-16px)] rounded-r-2xl transition-colors duration-300 ${isHovered ? 'bg-[#7E96F6]/15' : 'bg-slate-50'}`} style={{ transform: 'skewY(45deg) translateZ(-1px)' }} />
                                        ...
                                        >
                                            <div className="bg-slate-900 text-white text-[10px] font-black tracking-widest uppercase px-3 py-1.5 rounded-full flex items-center gap-2 shadow-xl whitespace-nowrap">
                                                <span className="w-1.5 h-1.5 rounded-full bg-[#7E96F6] shadow-[0_0_8px_#7E96F6] animate-pulse" />
                                    ...
                                    {index < layers.length - 1 && (
                                        <div className="absolute top-24 left-1/2 w-px h-16 bg-gradient-to-t from-slate-200 to-[#7E96F6]/50 overflow-hidden" style={{ transform: 'translateZ(-10px)' }}>
                                            <motion.div
                                                className="w-full h-4 bg-[#7E96F6] shadow-[0_0_10px_#7E96F6]"
                                                animate={{ y: [64, -16] }}
                ...
                <div className="max-w-xl">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 border border-slate-200 text-[#7E96F6] text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-sm">
                            <span className="w-2 h-2 rounded-full bg-[#7E96F6] animate-pulse" />
                            Systems Architecture
                        </div>

                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-normal text-black tracking-[0.1em] leading-[1.1] uppercase mb-8">
                            Our Multi-Layered <br />
                            <span className="text-black/20">Agentic Core.</span>
                        </h2>
